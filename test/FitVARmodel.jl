...
@testset "FitVARmodel.jl" begin
    ...
    @test model.d_h == 2
    @test model.d_y == 5
    @test model.B_hat ≈ [1.08838e-6  4.77665e-5  0.999997  -1.20926e-6  -0.000806239  0.999947] atol=1e-6
    ...
    @test model.Σ_β_hat ≈ [  1.28117e-12   3.10134e-10  -1.26739e-12  -1.42389e-12  -3.50158e-10  -3.44751e-10
                            ...
                            -3.44751e-10  -1.57129e-7    3.56748e-10   3.83227e-10   1.65932e-7    1.74601e-7] atol=1e-8
    @test model.Γ_hat ≈ [  1.0         -0.00126214    3.72491e-5   0.900158    -3.77317e-7   -0.00113679
                            ...
                            -0.00113679   6.09254e-6   -3.37771e-7  -0.00102389   8.50793e-10   5.48545e-6] atol=1e-6
    ...
    @test model2.B_hat ≈ [0.00182334  0.899947  0.99925  -0.00202657] atol=1e-6

    @test model3.B_hat ≈ [-1.85643e-5  0.817222  -7.31837] atol=1e-5

    @test model4.B_hat ≈ [-4.38661e-5  0.836412] atol=1e-6
